...
class TasksDifficultyModelTest(TestCase):
    ...
    def test_to_vector(self):
        ...
        self.assertEquals(Decimal('-0.58'), task_vector[0])
        self.assertEquals(-1, task_vector[1])
        self.assertEquals(1, task_vector[2])
        self.assertEquals(-1, task_vector[3])
        self.assertEquals(-1, task_vector[4])
        self.assertEquals(-1, task_vector[5])
        self.assertEquals(-1, task_vector[6])
