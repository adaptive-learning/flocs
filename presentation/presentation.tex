...
\item $b_t, a_t$ -- difficulty, difficulty factors vector
\end{itemize}
\end{frame}
...
\item skill factors update
  ...
  \item $\alpha_s[i] \leftarrow \max(\alpha_s[i], \hat{f}_{st})$
  \end{itemize}
...
\item 20 students, 100 solved tasks
...
\item missing "give me an easier task" button
\end{itemize}
\end{frame}
...
\item 45 unit tests, 200 commits, 44 closed issues
\end{itemize}
\end{frame}
